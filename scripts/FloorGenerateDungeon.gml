...
with(cur_floor){
    ...
    show_debug_message("----------------------------- FloorGenerateDungeon() -----------------------------");
    ...
    RoomListShift(room_list);//, 0, 0, width, height);
    ...
    */
    ...
    //door chance = 60, perlin_spacing  4, perlin_coef = 25, perlin_floor = 0.5
    var hall_time = current_time;
    AstarConnectRooms(link_list, 60, 4, 30, 0.5);//destroys link_list, creates treasure room locks
    ...
    //set fun values to rooms (must have dijkstra scans done before this
...
show_debug_message("created dungeon floor in "+string(current_time - time)+" milliseconds");
